...
import ParseWorking.ExtractInfoInterfax;
import ParseWorking.MoreResult;
import ParseWorking.ParseHTMLStringToTags_LinkedList;
import SQLinstruments.NewsRecord;
import SQLinstruments.SQLFunctionality;
...
public class DataExtractingNewsThreadSQL extends TimerTask {
    ...
    public void run() {
        ...
        try(Connection dbConnection = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD)) {
            ...
            java.net.URL newsPortal = new URL(NEWS_URL);
